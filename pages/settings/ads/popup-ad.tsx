...
const PopupAd = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Popup Ad'));
    }, [dispatch]);
    ...
    const handleSubmit = async (values: any, { resetForm }: any) => {
        ...
        try {
            ...
            console.log('Popup ad updated:', response.data);
            // Show success message
            Swal.fire({
                icon: 'success',
                title: 'Popup ad updated successfully',
                timer: 1000,
            ...
            Swal.fire({
                ...
                text: error.response?.data?.message || 'Failed to update Popup ad',
                timer: 1000,
                showConfirmButton: false
            });
    ...
    return (
        <div>
            <h5 className="text-xl font-semibold dark:text-white-light mb-5">Popup Ad</h5>
            <Formik
                initialValues={{
                    image: '',
                    img_url: '',
...
export default withAuth(PopupAd);