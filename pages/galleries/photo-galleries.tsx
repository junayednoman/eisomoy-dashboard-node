        ...
        <div>
            <div className="panel mt-5">
                <div className="mb-5 flex flex-col gap-5 md:flex-row md:items-center">
                    <h5 className="text-lg font-semibold dark:text-white-light">All Photo Galleries</h5>
                    ...
                    {isMounted && (
                        <DataTable
                            ...
                            columns={[
                                ...
                                { accessor: 'company', title: 'Photographer', sortable: true },
                                { accessor: 'phone', title: 'Publish Status', sortable: true },
                                { accessor: 'phone', title: 'Uploaded By', sortable: true },
                                { accessor: 'phone', title: 'Publish By', sortable: true },
                                { accessor: 'phone', title: 'Last Modified By', sortable: true },
                                { accessor: 'phone', title: 'Uploaded Datetime', sortable: true },
